...
public class ProcessTercerPrincipalExecutor {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		Process processTr = new ProcessBuilder("java","com.ramon.ejerciciosejemploruntime.TransformarString")
				.redirectErrorStream(true).directory(path).start();	
		Process processEx = new ProcessBuilder("java","com.ramon.ejerciciosejemploruntime.ExportarAFile",FILE.toString())
				.redirectErrorStream(true).directory(path).start();
